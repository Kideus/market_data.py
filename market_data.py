...
def download_data(symbol,start_date,end_date,crumb,cookie, dw_path):
	#Esto es el proceso de descarga
	yahoo_url_download = "https://query1.finance.yahoo.com/v7/finance/download/"+symbol+"?period1="+start_date+"&period2="+end_date+"&interval=1d&events=history&crumb="+crumb
...
for product in products:
	...
	download_data(product,unix_start_date,unix_end_date,get_crumb(resp),get_galleta(resp),files_path)
print("End download")
